<?php 
class Vsourz_Imagegallery_Adminhtml_CategoryController extends Mage_Adminhtml_Controller_action {
	protected function _initAction(){
		$this->loadLayout()->_setActiveMenu('imagegallery/imagecategory')->_addBreadcrumb(
			Mage::helper('adminhtml')->__('Manage Category'),
	...
	public function newAction(){
		$this->loadLayout();
		$this->_addContent($this->getLayout()->createBlock('imagegallery/adminhtml_category_edit'))->_addLeft($this->getLayout()->createBlock('imagegallery/adminhtml_category_edit_tabs'));
		$this->renderLayout(); 
	}
	...
	public function editAction(){
		...
		$this->_title($this->__('imagegallery'))->_title($this->__('Edit Category'));
		$this->loadLayout();
		$this->getLayout()->getBlock('head')->setCanLoadExtJs(true);
		$this->_addContent($this->getLayout()->createBlock('imagegallery/adminhtml_category_edit'))
		->_addLeft($this->getLayout()->createBlock('imagegallery/adminhtml_category_edit_tabs'));
		$this->renderLayout();
	}
	...
	public function massDeleteAction(){
		...
		if(!is_array($ids)) {
			...
			try{
				$imageModel = Mage::getModel('imagegallery/imagecategory');
				foreach($ids as $id){
